...
export const SidePanel = () => {
  const { status, score , moveRecord, gameLevel} = useTetrisContext();
  ...
  return <div className="w-[200px] flex-shrink-0 flex flex-col gap-[10px]">
    ...
    <div className="bg-[#1D1D1D] rounded-[13.183px] p-5 border-[0.412px] border-[#3A3A3A]">
      ...
      <div className="relative mt-5">
        ...
        <svg viewBox="0 0 46 63" fill="none" xmlns="http://www.w3.org/2000/svg" className="absolute -bottom-1 left-1/2 w-[18.302px] h-[25.7px]" style={{ transform: `translateX(-50%) rotate(${gameLevel.current === 'medium' ? '0' : gameLevel.current === 'hard' ? '90' : '-90'}deg)` }}>
